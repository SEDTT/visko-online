 ...
 * additional message should be provided for more detail. These are
 * automatically serialized by Gson because they are so simple.
 * 
 * I.e. they will look like { "message" : message, "type" : class_name }
 * 
 * @author awknaust
 * 
 */
