...
abstract class ServiceError extends PipelineError {
	...
	public function __construct($userID, $pipelineID, $serviceIndex, $serviceURI, $timeOccurred = null, $id = null) {
...
class ServiceExecutionError extends ServiceError {
	...
	public function __construct($userID, $pipelineID, $serviceIndex, $serviceURI, $timeOccurred = null, $id = null) {
		parent::__construct ( $userID, $pipelineID, $serviceIndex, $serviceURI, $timeOccurred, $id );
...
class InputDataURLError extends PipelineError {
	...
	public function __construct($userID, $pipelineID, $datasetURL, $timeOccurred = null, $id = null) {
		parent::__construct ( $userID, $pipelineID, $timeOccurred, $id );
