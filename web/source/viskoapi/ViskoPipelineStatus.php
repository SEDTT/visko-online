 ...
 * a pipeline.
 * Is Serialized from the JSON response.
 *
 * @author awknaust
 *        
 */
class ViskoPipelineStatus implements JsonDeserializable {
	...
	public function init($completedNormally = false, $resultURL = null, $serviceIndex = null, $serviceURI = null, $pipelineState = null, $stateMessage = null) {
	...
	/**
	 * Return the URL of the final visualization.
	 * Only
	...
	/**
	 * Return the index (w.r.t.
	 * the pipeline) of the executing
