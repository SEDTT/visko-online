...
class PipelineStatus {
	 ...
	 *
	 * @param
	 *        	pipelineID int the integer of the pipeline that this status describes
	 * @param
	 *        	completedNormally boolean if the pipeline completed normally
	 * @param
	 *        	resultURL String URL of visualization
	 * @param
	 *        	serviceIndex int position of last-attempted service in pipeline
	 * @param
	 *        	dateExecuted Date the date it was executed
	 * @param
	 *        	id int the database ID of this object.
	 */
	public function __construct($pipelineID, $completedNormally = false, $resultURL = null, $serviceIndex = null, $dateExecuted = null, $id = null) {
