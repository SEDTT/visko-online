...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<div class="right_header">
					...
					<fieldset>
						<table>
							...
							<form id='register1' action='<?php echo $fgmembersite->GetSelfScript();  ?>' method='post' accept-charset='UTF-8'>
								<tr>
									<td>
								...
								<tr>
									...
									<td>
										...
										<span id='register_U_pwd_errorloc' class='error'></span>
		...
		<script type='text/javascript'>
			// <![CDATA[
			var frmvalidator = new Validator("register1");
