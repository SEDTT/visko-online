...
class FGMembersite{
    ...
    function createUserTable(){
        $qry = "CREATE TABLE IF NOT EXIST $this->tablename (".
    ...
    function InsertIntoUser(&$formvars){
        ...
        $insert_query = 'INSERT INTO ' . $this->tablename.'(U_email, U_first, U_last, U_pwd, U_reg_user, U_confirmed, U_reg_date, U_affiliation)
                values(
                "' . $this->SanitizeForSQL($formvars['U_email']) . '",
                "' . $this->SanitizeForSQL($formvars['U_first']) . '",
                "' . $this->SanitizeForSQL($formvars['U_last']) . '",
                "' . md5($formvars['U_pwd']) . '",
                "' . $this->SanitizeForSQL($formvars['U_reg_user']) . '",
                "' . $this->SanitizeForSQL($formvars['U_confirmed']) . '",
